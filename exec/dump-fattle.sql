CREATE DATABASE IF NOT EXISTS `fattle`;
...
INSERT INTO `avatar_tb` VALUES ('PK1',1,'귀여운 알','src/assets/svg/avatar/img1.svg','src/assets/svg/avatar/profileImg1.svg'),('PK2',2,'귀여운 살덩이','src/assets/svg/avatar/img2.svg','src/assets/svg/avatar/profileImg2.svg'),('PK3',3,'귀여운 팬더','src/assets/svg/avatar/img3.svg','src/assets/svg/avatar/profileImg3.svg'),('PK4',4,'귀여운 빅팬더','src/assets/svg/avatar/img4.svg','src/assets/svg/avatar/profileImg4.svg'),('PK5',5,'사나운 빅빅팬더','src/assets/svg/avatar/img5.svg','src/assets/svg/avatar/profileImg5.svg');
...
INSERT INTO `battle_betting_tb` VALUES (52,'DOLWGT','50만원');
...
INSERT INTO `battle_player_tb` VALUES ('DOLWGT',3300113746,77,0,66,50,0,10,0,0,0,0),('DOLWGT',3324144987,100,0,90,50,0,0,0,0,0,0);
...
CREATE TABLE `battle_point_tb` (
  ...
  `trigger_cd` bigint DEFAULT NULL,
...
INSERT INTO `battle_point_tb` VALUES (61,'DOLWGT',3324144987,NULL,3,50,'2024-02-16 00:47:33'),(62,'DOLWGT',3300113746,NULL,3,50,'2024-02-16 00:47:48'),(63,'DOLWGT',3300113746,3300113746,1,10,'2024-02-16 00:48:40');
...
CREATE TABLE `battle_tb` (
  ...
  `end_dt` timestamp NULL DEFAULT ((now() + interval 7 day)),
...
INSERT INTO `battle_tb` VALUES ('DOLWGT',3324144987,'배틀','2024-02-16 00:46:42','2024-02-23 00:46:42',1);
...
INSERT INTO `exercise_tb` VALUES (166,3336997817,'RUN','2024-02-16 00:21:45');
...
INSERT INTO `exp_history_tb` VALUES (266,3323676782,'2024-02-16 00:13:18','출석',2,'완료'),(267,3336997817,'2024-02-16 00:13:30','출석',2,'완료'),(268,3331199655,'2024-02-16 00:15:34','출석',2,'완료'),(269,3324144987,'2024-02-16 00:20:00','출석',2,'완료'),(270,3300113746,'2024-02-16 00:21:02','출석',2,'완료'),(271,3336997817,'2024-02-16 00:21:44','운동',750,'달리기');
...
CREATE TABLE `follow_tb` (
  `follow_cd` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `follow_tb` VALUES (1,3319955502,3300113746),(2,3319955502,3324144987),(3,3319955502,3323676782),(4,3319955502,3336997817),(5,3300113746,3319955502),(6,3324144987,3319955502),(7,3323676782,3319955502);
...
CREATE TABLE `food_board_tb` (
  `food_board_cd` int NOT NULL AUTO_INCREMENT,
  `battle_cd` char(6) NOT NULL,
  `player_cd` bigint NOT NULL,
  `rec_dt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `img_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `food_comment_tb` (
  `food_comment_cd` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `health_tb` VALUES (44,3323676782,195,80,'2024-02-16 00:13:14'),(46,3336997817,180,77,'2024-02-16 00:13:28'),(47,3331199655,165,67,'2024-02-16 00:15:33'),(48,3324144987,200,100,'2024-02-16 00:19:58'),(49,3300113746,183,77,'2024-02-16 00:21:01');
...
INSERT INTO `quest_tb` VALUES ('2024-02-16 00:13:18',3323676782,1,0,0,0),('2024-02-16 00:13:30',3336997817,1,1,0,0),('2024-02-16 00:15:34',3331199655,1,0,0,0),('2024-02-16 00:20:00',3324144987,1,0,0,0),('2024-02-16 00:21:02',3300113746,1,0,0,0);
...
INSERT INTO `user_tb` VALUES (1,'PK2','육도선인','M','2024-02-16 00:41:52',0,0,0,0,0,650,0,NULL),(2,'PK2','시조의거인','M','2024-02-16 00:41:52',0,0,0,0,0,785,0,NULL),(3,'PK2','해적왕','M','2024-02-16 00:41:52',0,0,0,0,0,991,0,NULL),(3300113746,'PK1','정몬','M','2024-02-16 00:21:01',66,1930,193,193,43,2,0,NULL),(3323676782,'PK4','윤모다','M','2024-02-16 00:13:14',70,1930,241,145,43,2359,0,NULL),(3324144987,'PK1','강주원','M','2024-02-16 00:19:58',90,1930,39,106,150,2,0,NULL),(3331199655,'PK3','안녕창휘','M','2024-02-16 00:15:33',57,1930,170,106,150,1465,0,NULL),(3336997817,'PK2','창휘야','M','2024-02-16 00:13:28',67,1930,193,193,100,752,0,NULL);
...
-- Dump completed on 2024-02-16  9:50:47
